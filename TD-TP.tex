...
\end{lstlisting}
    ...
    */
    ...
    \begin{solutionorbox}
        $
        \WLP(12-16,I) = WLP(12-15,I[i++])\\
        \WLP(12-16,I) =  tab[i] < min \Rightarrow \WLP(13,I') \wedge tab[i] > max \Rightarrow WLP(15,I')\\
        WLP(12-16,I) = tab[i] < min \Rightarrow I'[min \leftarrow tab[i]] \wedge tab[i] > max \Rightarrow I'[max \leftarrow tab[i]]
        \\ \\
        I' = I[i++]
        $
        \\ \\
