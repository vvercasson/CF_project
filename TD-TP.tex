...
int abs(int n)
{
    ...
    \begin{solutionorbox}
        ...
        \WP(\code{abs},\psi) \equiv (n<0 \Rightarrow -n == abs(n)) \land (n \geq 0 \Rightarrow n == abs(n))\\
        \WP(\code{abs},\psi) \equiv n<0 \lor n \geq 0(trivial)\\
        \WP(\code{abs},\psi) \equiv \bot
        $
        \\ \\
...
int min_dist(int *tab, unsigned int n)
{
    ...
    \begin{solutionorbox}
        ...
        \WLP(19-21,I) \equiv (min_i < min) \Rightarrow \WLP(20,I')\\
        \WLP(19-21,I) \equiv (min_i < min) \Rightarrow I'[min = min_i]
        \\ \\
        I' = I[i++]
        $
    \end{solutionorbox}
