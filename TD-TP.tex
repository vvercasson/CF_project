...
int abs(int n)
{
    ...
    \begin{solutionorbox}
        ...
        \WP(\code{abs},\psi) = n<0 \lor n \geq 0
        $
        \\ \\
        $ \{n<0 \lor n \geq 0\}abs\{\result == abs(n)\} $ est un triplet de \bsc{Hoare} valide.
    ...
    \begin{solutionorbox}
        La valeur de la variable n doit aussi comprendre les condtion $n < INTMAX$ et $n>INTMIN$
...
\end{lstlisting}
    ...
    \begin{solutionorbox}
        $
        requires \quad n \geq INT\_MIN;\\
        requires \quad n < INT\_MAX;
        $
    \end{solutionorbox}
    ...
    */
    ...
    \begin{solutionorbox}
        ...
        I = I1 ∧ I2 ∧ I3 ∧ I4 ∧ I5
        \\ \\
        On peut justifier $\neg(i < n) ∧ I \Rightarrow \WLP(18,\phi)$ car cela revient à dire que quand on termine la boucle $(i=n) \iff \neg(i < n)$, 
    ...
    \begin{solutionorbox}
        Ainsi, on a bien $i<n ∧I1∧I2∧I3∧I4∧I5 \Rightarrow WLP(12-16,I1∧I2∧I3∧I4∧I5)$, et donc on a bien un invariant de boucle.
        \\ \\
